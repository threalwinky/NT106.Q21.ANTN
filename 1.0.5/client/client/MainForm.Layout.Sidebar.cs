...
partial class MainForm
{
    ...
    private Control BuildInternetSettingsCard()
    {
        ...
        AddField(table, 3, "Policy", ConfigureStaticStatusLabel("Internet uses the hardcoded public services. LAN derives all URLs from the Server IP entered on the login page."));
