...
partial class MainForm
{
    private void BuildAuthShell()
    {
        ...
        var networkOverlay = BuildNetworkOverlay();
        networkOverlay.Location = new Point(432, 20);
        networkOverlay.Anchor = AnchorStyles.Top | AnchorStyles.Right;
        _authCardPanel.Controls.Add(networkOverlay);
    ...
    private Control BuildNetworkOverlay()
    {
        ...
        var comboHost = ConfigureAuthNetworkModeComboBox();
        comboHost.Dock = DockStyle.None;
        comboHost.Width = 160;
        comboHost.Margin = new Padding(0);
        panel.Controls.Add(comboHost);

        var ipHost = ConfigureLanServerIpTextBox();
        ipHost.Dock = DockStyle.None;
        ipHost.Width = 160;
        ipHost.Margin = new Padding(0, 4, 0, 0);
        _lanServerIpField = ipHost;
        _lanServerIpField.Visible = false;
        panel.Controls.Add(ipHost);
