    ...
    async def websocket_endpoint(websocket: WebSocket) -> None:
        ...
        try:
            while True:
                ...
                binary_message = packet.get("bytes")
                if binary_message is not None:
                    ...
                    if not binary_message.startswith(SECURE_FRAME_MAGIC):
                    ...
                    await room_service.broadcast_bytes(room, binary_message, exclude_client_id=current_client_id)
                    continue
