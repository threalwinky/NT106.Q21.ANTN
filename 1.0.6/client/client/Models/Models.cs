...
internal sealed record ProcessRequestInfo(
    string RequestId,
    string RequesterClientId,
    string RequesterDisplayName);

internal sealed record ProcessSnapshotInfo(
    string RequestId,
    string MachineName,
    DateTime CapturedAtUtc,
    int ProcessorCount,
    long TotalMemoryBytes,
    IReadOnlyList<RemoteProcessInfo> Processes);

internal sealed record RemoteProcessInfo(
    int ProcessId,
    string Name,
    string WindowTitle,
    double CpuPercent,
