...
partial class MainForm
{
    ...
    private Control BuildGeneralSettingsCard()
    {
        ...
        AddField(table, 0, "Display Name", ConfigureTextBox(_displayNameTextBox, "Host-01"));
        AddField(table, 1, "Theme", ConfigureThemeToggleCheckBox());
    ...
    private Control BuildInternetSettingsCard()
    {
        ...
        AddField(table, 0, "Internet Main TCP", ConfigureStaticStatusLabel(client.Networking.NetrixEndpoints.MainServerTcp));
        AddField(table, 1, "Auth API", ConfigureStaticStatusLabel(client.Networking.NetrixEndpoints.AuthServer));
        AddField(table, 2, "Load Balancer", ConfigureStaticStatusLabel(client.Networking.NetrixEndpoints.LoadBalancer));
        AddField(table, 3, "Policy", ConfigureStaticStatusLabel("Internet uses public TCP sockets. LAN derives LB/auth/main TCP endpoints from the Server IP entered on the login page."));
