...
partial class MainForm
{
    private async Task CreateRoomAsync()
    {
        ...
        try
        {
            ...
            var selection = await ResolveServerSelectionAsync(null, cts.Token);
            await EnsureConnectedAsync(selection.TcpEndpoint, cts.Token);
    ...
    private async Task JoinRoomAsync()
    {
        ...
        try
        {
            ...
            var selection = await ResolveServerSelectionAsync(roomId, cts.Token);
            await EnsureConnectedAsync(selection.TcpEndpoint, cts.Token);
