...
partial class MainForm
{
    ...
    private Control BuildRemoteToolbar()
    {
        ...
        ConfigureToolbarButton(_showProcessesButton, "Show Processes");
        ...
        _showProcessesButton.Size = new Size(132, 40);
        _showProcessesButton.MinimumSize = new Size(132, 40);
        _showProcessesButton.Margin = new Padding(8, 0, 0, 0);
        ...
        toolbar.Controls.Add(_showProcessesButton, 3, 0);
        toolbar.Controls.Add(_toggleFullScreenButton, 4, 0);
    ...
    private Control BuildRemoteCanvas()
    {
        ...
        _remoteScreenBox.AllowDrop = true;
