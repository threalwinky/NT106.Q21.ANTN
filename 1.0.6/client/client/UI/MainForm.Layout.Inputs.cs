...
partial class MainForm
{
    ...
    private Control ConfigureAuthNetworkModeComboBox()
    {
        _authNetworkModeComboBox.DropDownStyle = ComboBoxStyle.DropDownList;
        _authNetworkModeComboBox.Items.AddRange(new object[] { "LAN", "Internet" });
        _authNetworkModeComboBox.SelectedIndex = 1;
        return CreateComboInputHost(_authNetworkModeComboBox);
    }

    private Control ConfigureLanServerIpTextBox()
    {
        _lanServerIpTextBox.PlaceholderText = "192.168.1.50";
        return CreateTextInputHost(_lanServerIpTextBox);
    }
