...
internal sealed class DesktopDuplicationScreenCaptureBackend : IScreenCaptureBackend
{
    ...
    public RemoteFrame? CaptureFrame()
    {
        ...
        return bitmap is null ? null : _encoder.Encode(bitmap);
    }
    ...
    public Bitmap? CaptureBitmap()
    {
        ...
        try
        {
            ...
            try
            {
                return CreateBitmap(mapped, sourceDescription.Width, sourceDescription.Height);
            }
            finally
            {
    ...
    private static unsafe Bitmap CreateBitmap(MappedSubresource mappedSubresource, uint width, uint height)
    {
        ...
        try
        {
            ...
            {
                var sourceRow = (byte*)mappedSubresource.DataPointer + (rowIndex * (int)mappedSubresource.RowPitch);
                var targetRow = (byte*)bitmapData.Scan0 + (rowIndex * bitmapData.Stride);
